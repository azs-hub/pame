		  ...
		  <div class="cart-detail">
		    <div class="cart-content">
		      ...
		      <div class="cart-content-btn">
		        <button type="button" class="back" data-dismiss="modal">{l s='Continue shopping' d='Shop.Theme.Actions'}</button>
		        <a href="{$cart_url}" class="checkout">{l s='Proceed to checkout' d='Shop.Theme.Actions'}</a>
		      </div>
		    </div>
		  </div>
        </div>
